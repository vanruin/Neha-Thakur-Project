...
module.exports.loader = (_0x4705f2, _0x10a189) => {
  switch (_0x10a189) {
    case "warn":
      console.log(chalk.bold.hex(randomColor()).bold("The-Neha error•—»✨ ") + chalk.bold.hex("#8B8878").bold(_0x4705f2) + chalk.bold.hex("FF00DD")(''));
      break;
    case "error":
      console.log(chalk.bold.hex(randomColor()).bold("The-Neha error•—»✨ ") + _0x4705f2 + chalk.bold.hex("5EFF00")(''));
      break;
    default:
      console.log(chalk.bold.hex(randomColor()).bold("The-Neha•—»✨ ") + chalk.bold.hex(randomColor()).bold(_0x4705f2) + chalk.bold.hex("FFF0000")(''));
      break;
  }
};
